...
@section('content')
    <section class="content-header">
      ...
      <span class="breadcrumb"><a href='{{ route("information.create") }}' class="btn btn-sm btn-primary"><i class="fa fa-plus-square"></i>&nbsp;&nbsp;Create New Information</a></span>
    </section>
    <div class="content">
                        ...
                        <tr>
                          ...
                          <td>
                           <a href="{!! route('information.edit', [$info->id]) !!}"
                            ...
                            <a href="#" type="button" data-id="{{ $info->id }}"
                               class="btn btn-xs btn-danger" data-toggle="modal"
                               data-url="{{ url('admin/information/'.$info->id) }}"
